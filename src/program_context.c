    ...
    while (ret) {
        ...
        switch (opt) {
            ...
            case 'l':
                ...
                break;
            case 'w':
                program_context_put_integer(self, "width",
                                            atoi(optarg));
                break;
            case 'h':
                program_context_put_integer(self, "height",
                                            atoi(optarg));
                break;
            case 'x':
                program_context_put_integer(self, "x",
                                            atoi(optarg));
                break;
            case 'y':
                program_context_put_integer(self, "y",
                                            atoi(optarg));
                break;
            case 't':
                program_context_put_integer(self, "transparency",
                                            atoi(optarg));
                break;
            case 'f':
                program_context_put(self, "fbdev",
                                    optarg);
                break;
            default:
                ret = FALSE;
