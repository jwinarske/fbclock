...
void string_append_c(String *self, uint32_t c);
...
void string_delete(String *self, int pos, int len);

void string_insert(String *self, int pos, const char *replace);

BOOL string_create_from_utf8_file(const char *filename, String **result, char **error);

String *string_encode_url(const char *s);

void string_append_byte(String *self, BYTE byte);
